...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="/"><strong className="">PANDEY</strong></NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink  activeClassName = 'menu_active'exact className="nav-link" to="/contact">Partner With Us</NavLink>
        </li>
